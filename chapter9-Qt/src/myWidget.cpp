...
#ifdef _MSC_VER
    myShader = new Shader("../../chapter9-Qt/src/shader.vs", "../../chapter9-Qt/src/shader.fs", QOpenGLContext::currentContext()->functions());
#else
	myShader = new Shader("../chapter9-Qt/src/shader.vs", "../chapter9-Qt/src/shader.fs", QOpenGLContext::currentContext()->functions());
#endif
...
void MyGlWidget::paintGL()
{
	...
	for (unsigned int i = 0; i < 10; i++)
    {
        ...
        float currentTimeSec = currentTime.second() + currentTime.msec()/1000.0f;
        float angle = currentTimeSec * 20.0f + 20.0f * i;
